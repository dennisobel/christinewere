                ...
                <div className="col-lg-3 col-md-6 col-6">
                  <div className="navbar-header">
                    ...
                    <Link
                      ...
                      to="/home"
                    >
                      <div className="slide-text"><br></br><h2>GEHEN2</h2></div>
                    </Link>
                  </div>
                </div>
                    ...
                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                      ...
                      <li className="menu-item-has-children">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li>
                            <Link onClick={ClickHandler} to="/case-single/1">
                              Cases Single
                            </Link>
                          </li>
                        </ul>
                      ...
                      <li className="menu-item-has-children">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li>
                            <Link onClick={ClickHandler} to="/shop-single/1">
                              Shop Single
                            </Link>
                          </li>
                          <li>
